...
import { fireEvent, render, screen, trpc } from './utils'
...
describe('[endpoint].preload', () => {
	...
	it('Should avoid preloading the resource multiple times', async () => {
		...
		// Preload in paralell
		const paralell = [trpc.preloadTest.exec.preload(), trpc.preloadTest.exec.preload(), trpc.preloadTest.exec.preload()]
